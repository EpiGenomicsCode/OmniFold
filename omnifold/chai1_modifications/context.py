...
import pprint
logger.warning(f"DEBUG: CHAI_TEMPLATE_CIF_FOLDER is set to: {os.environ.get('CHAI_TEMPLATE_CIF_FOLDER')}")
logger.warning(f"DEBUG: Full environment variables at module load time:\n{pprint.pformat(os.environ)}")
