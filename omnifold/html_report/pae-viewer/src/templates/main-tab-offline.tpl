    ...
    <div>
        ...
        <div class="card" style="margin-bottom: 1em">
            <div class="card-body font-monospace small">
                ...
                &nbsp;&nbsp; --structure resources/sample/GatA-GatB/fold_gata_gatb_model_0.cif \<br/>
                &nbsp;&nbsp; --labels 'GatA;GatB' \<br/>
                &nbsp;&nbsp; --scores resources/sample/GatA-GatB/fold_gata_gatb_full_data_0.json \<br/>
                &nbsp;&nbsp; --crosslinks resources/sample/GatA-GatB/GatA-GatB.csv <br/>
            </div>
        </div>
